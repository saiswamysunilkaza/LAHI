...
db_jira_agent = Agent(
    ...
    2. If no matching JIRA is found, respond exactly with: "Unfortunately, no jira with this description found in AI solution stack" and return control to the unix_agent.
    4. If a match is found, explain the root cause, reasoning for the solution, and suggest preventive actions and call task_complete return control to the unix_agent..
    5. Once you have provided the required information, you must call task_complete to return control to the unix_agent.
    """,
